...
| Path                                                            | What                                                |
| --------------------------------------------------------------- | --------------------------------------------------- |
| `/Users/dave/Documents/Claude/Projects/milkwise-claude-design/milkwise/` | **Project root** — the Expo app                  |
...
- **`final-design-rebuild`** ⭐ **active** — cut from `FinalDesign`. Pushed at `6dd906e` (Phases 0–1); subsequent commits (`ac618b8` for Phases 2–9 + the Calculator rebuild + this CLAUDE.md trim) are local and ready to push.
